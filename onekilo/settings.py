...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-n=2f3jv)s*9g_wqefq4#@subj@0)=cr2!zqn1t18ufd*r5+5h8')
...
# --- CONFIGURATION DES FICHIERS STATIQUES (Sécurité & Admin) ---
STATIC_URL = '/static/'
